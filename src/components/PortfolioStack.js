...
const PROJECTS = [
    ...
    },
    {
        ...
        cover: workImage('pr-kits-project-card'),
        gallery: [
            workImage('pr-kits-detail-landscape-1'),
            workImage('pr-kits-detail-landscape-2'),
    ...
    },
    {
        ...
        cover: workImage('structural-project-card'),
        gallery: [
            workImage('structural-detail-landscape-1'),
            workImage('structural-detail-landscape-2'),
            workImage('structural-detail-landscape-3'),
            workImage('structural-detail-landscape-4'),
            workImage('structural-detail-landscape-5'),
            workImage('structural-detail-landscape-6'),
            workImage('structural-detail-portrait-7'),
        ],
    },
    {
        slug: 'design-toolbox',

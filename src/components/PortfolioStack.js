...
const PROJECTS = [
    {
        ...
        cover: workImage('pixlz-nyc-launch-party-3'),
        gallery: [
            workImage('pixlz-nyc-launch-party-3'),
            workImage('pixlz-blue-raspberry-product-packaging'),
            workImage('pixlz-tropical-rush-product-packaging'),
            workImage('pixlz-berry-blast-product-packaging'),
            workImage('pixlz-arcade-cabinet-wrap'),
            workImage('pixlz-brand-ambassador-holding-product-at-event'),
            workImage('pixlz-event-table-display'),
        ],
    },
    {
        slug: 'gron-halloween',
        ...
        cover: workImage('gron-bite-club-nocturnal-nectar-pearls-product-hero'),
        gallery: [
            workImage('gron-bite-club-nocturnal-nectar-pearls-product-hero'),
            workImage('gron-bite-club-vampire-lips-photography'),
            workImage('gron-bite-club-logo-chrome-title-card'),
            workImage('gron-bite-club-vampires-kiss-mega-gummy-and-pouch'),
            workImage('gron-arcana-custom-tarot-deck'),
            workImage('gron-arcana-mellow-moon-mega-product'),
            workImage('gron-arcana-star-spell-pearls-product'),
        ],
    },
    {
        slug: 'gron-core',
